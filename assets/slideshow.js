...
class Slideshow {
  ...
  childNavGoTo(index) {
    ...
    var useVerticalThumbScroll =
      this.args.childVertical && typeof window.matchMedia !== "undefined" && window.matchMedia("(min-width: 769px)").matches;
    if (useVerticalThumbScroll) {
